...
const C = {
  ...
  gray:"#5F5E5A", grayL:"#F1EFE8", purple:"#534AB7", purpleL:"#EEEDFimport { useState } from "react";
...
const NAV=[
  ...
  {section:"Futuro",items:[{key:"futuro",label:"Fase 2"}]},
];
const PAGE_LABELS={overview:"Visão Geral",architecture:"Arquitetura",roadmap:"Roadmap",team:"Equipe",proto_dir:"Protótipo · Diretoria",proto_ger:"Protótipo · Gerente",futuro:"Futuro · Fase 2"};
...
function PageOverview(){
  ...
  const systems=[
    ...
    },
    {
      ...
      desc:"Painel web interno para quem administra o sistema. Permite criar e desativar usuários, definir qual perfil cada pessoa tem (Diretoria ou Gerente), vincular cada gerente às suas áreas e cidades de responsabilidade, e configurar os limites que disparam os alertas no app.",
      feats:[
    ...
    },
    {
      ...
      desc:"Camada técnica invisível para os usuários. Conecta diretamente no banco do Protheus, extrai os dados brutos de faturamento e margem, transforma e disponibiliza via API para o app e o backoffice. É o que garante que os números no app sejam os mesmos do ERP — sem intermediários, sem e-mail, sem planilha manual.",
      feats:[
    ...
    <div style={{flex:1,overflowY:"auto",padding:24,display:"flex",gap:20,alignItems:"flex-start"}}>
      ...
      <div style={{width:220,minWidth:220,display:"flex",flexDirection:"column",gap:12}}>
        ...
        <div style={{...card(),padding:16}}><ST>Estimativas</ST>
          {[
            {l:"Gestor de Projetos",   v:"40h/mês · M1–M3", w:false},
    ...
    <div style={{flex:1,overflowY:"auto",backgroundColor:C.bg}}>
      ...
      <div style={{padding:"20px 24px 32px"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:12,marginBottom:20}}>
          {[
            {accent:"#3B6D11", lbl:"PESSOAS NO TIME",  val:"6",        sub:"Papéis distintos e complementares"},
...
// ═══════════════════════════════════════════════════════════════════════════════
function PageFuturo(){
  const [tema,setTema]=useState("vendedor");
  ...
  const TEMAS=[
    {
      ...
      icone:"👤",
      cor:"#C8102E", corL:"#FDECEA",
      tagline:"400+ vendedores sem visibilidade do próprio desempenho",
      problema:"Hoje o vendedor não sabe se está batendo a meta sem perguntar ao gerente. Atua no escuro — sem saber quais clientes estão sumindo da carteira, qual o ticket médio de cada um, quem não compra há 60 dias.",
      impacto_resumo:"Mais autonomia → mais ação → mais resultado",
      perfis:["VD · Vendedor"],
      novo_perfil:true,
      features:[
        {
          nome:"Home — minha meta e realizado",
          tag:"MVP F2",
          o_que:"KPIs pessoais do vendedor: faturamento realizado vs meta, % atingido e ritmo diário necessário para fechar o mês.",
          gera:"Vendedor age sem depender do gerente. Cada hora do dia passa a ter peso na meta.",
          icone_neg:"⏳", icone_pos:"⚡",
        },
        {
          nome:"Carteira com status de saúde",
          tag:"MVP F2",
          o_que:"Lista de clientes classificados automaticamente: Ativo (comprou em até 30d), Em risco (30–60d sem compra), Inativo (60d+). Ordenada por criticidade.",
          gera:"Vendedor sabe exatamente quem ligar hoje. Sem cruzar planilha com ERP, sem esperar relatório.",
          icone_neg:"🗂️", icone_pos:"🎯",
        },
        {
          nome:"Alerta de cliente sem compra",
          tag:"MVP F2",
          o_que:"Push automático quando um cliente da carteira chega em 30, 60 ou 90 dias sem pedido. Mostra o último valor comprado para embasar a abordagem.",
          gera:"Reativação proativa. O vendedor age antes de o cliente sair — não depois.",
          icone_neg:"😶", icone_pos:"🔔",
        },
        {
          nome:"Ticket médio por cliente + tendência",
          tag:"MVP F2",
          o_que:"Ticket médio dos últimos 3 meses por cliente com seta de tendência. Destaca quedas acima de 20%.",
          gera:"Detecta clientes migrando para concorrentes antes que saiam completamente da carteira.",
          icone_neg:"🔍", icone_pos:"📈",
        },
        {
          nome:"Cross-sell por cliente",
          tag:"F2+",
          o_que:"Mostra quais famílias de produto o cliente nunca comprou. Ex: compra rolamentos SKF mas nunca pediu correias Continental.",
          gera:"Cada visita vira uma oportunidade com argumento concreto — sem depender da memória do vendedor.",
          icone_neg:"💸", icone_pos:"🔀",
        },
        {
          nome:"Ranking da filial",
          tag:"F2+",
          o_que:"Posição no ranking de faturamento e % de meta entre os vendedores da mesma filial. Atualizado diariamente.",
          gera:"Competição saudável. Estudos mostram +11–15% de performance em equipes com visibilidade de ranking.",
          icone_neg:"🤷", icone_pos:"🏆",
        },
      ],
    },
    {
      ...
      icone:"📊",
      cor:"#185FA5", corL:"#E6F1FB",
      tagline:"Fase 1 mostra o que aconteceu. Fase 2 explica por quê e antecipa o que vem",
      problema:"Com 23 mil SKUs, 10 filiais e 3 segmentos de comportamento completamente distinto (agro tem safra, industrial tem manutenção, automotivo tem sazonalidade própria), decisões baseadas em feeling custam caro.",
      impacto_resumo:"Menos intuição, mais decisão baseada em padrão",
      perfis:["DIR · Diretoria","GER · Gerente"],
      novo_perfil:false,
      features:[
        {
          nome:"Curva ABC de clientes",
          tag:"MVP F2",
          o_que:"Classifica clientes em A (top 20% que geram 80% do faturamento), B e C. Mostra quais clientes A estão com queda de frequência.",
          gera:"Gerente concentra energia onde mais importa. Perder 1 cliente A equivale a perder 4 clientes B.",
          icone_neg:"🎲", icone_pos:"🔠",
        },
        {
          nome:"Ranking de filiais",
          tag:"MVP F2",
          o_que:"10 filiais rankeadas por % de meta, crescimento mês a mês e % MC. Drill-down por segmento e período.",
          gera:"Identifica filiais modelo e filiais em queda — intervenção cirúrgica, não boletim de reunião.",
          icone_neg:"🤔", icone_pos:"🏅",
        },
        {
          nome:"Sazonalidade por segmento",
          tag:"MVP F2",
          o_que:"Histórico de pico e vale por segmento. Agro: safra set–jan. Industrial: manutenção programada. Automotivo: picos no 1º semestre.",
          gera:"Metas e estoque planejados com padrão histórico real. Sem ser pego de surpresa pela safra.",
          icone_neg:"🌪️", icone_pos:"🌾",
        },
        {
          nome:"Detecção de churn automática",
          tag:"F2+",
          o_que:"Detecta clientes com queda consecutiva de frequência por 2+ períodos. Gera lista priorizada para ação do gerente ou vendedor.",
          gera:"Retenção custa 5× menos que aquisição. Agir antes de perder muda completamente o resultado.",
          icone_neg:"👋", icone_pos:"⚠️",
        },
        {
          nome:"Mix — SKUs sem giro na carteira",
          tag:"F2+",
          o_que:"Produtos que o mercado compra mas o cliente específico nunca pediu. Cruza os 23k SKUs com histórico do cliente.",
          gera:"Mais receita por cliente existente, sem novo custo de aquisição. Portfólio completo sendo usado de verdade.",
          icone_neg:"📦", icone_pos:"🔍",
        },
      ],
    },
    {
      ...
      icone:"⚡",
      cor:"#BA7517", corL:"#FFF3DC",
      tagline:"Fase 1 alerta quando o número já caiu. Fase 2 alerta antes",
      problema:"Em distribuição B2B com ciclos de compra regulares, desvios do padrão são sinais antecipados. Mas hoje esses sinais só aparecem quando o resultado do mês já está comprometido.",
      impacto_resumo:"Do reativo para o proativo — agir antes que o problema apareça",
      perfis:["DIR · Diretoria","GER · Gerente","VD · Vendedor"],
      novo_perfil:false,
      features:[
        {
          nome:"Alerta: cliente VIP sem compra",
          tag:"MVP F2",
          o_que:"Clientes do grupo A que ficam X dias sem comprar geram alerta prioritário para gerente e vendedor. Threshold configurável por segmento.",
          gera:"1 cliente VIP pode representar R$ 500K+/ano. Um alerta precoce pode salvar a conta.",
          icone_neg:"😴", icone_pos:"👑",
        },
        {
          nome:"Alerta: vendedor com queda de ticket",
          tag:"MVP F2",
          o_que:"Ticket médio de um vendedor cai por 2 semanas consecutivas → gerente recebe alerta com comparativo vs média da filial.",
          gera:"Intervenção antes de impactar o mês. Gerente age no problema certo, não no sintoma.",
          icone_neg:"📉", icone_pos:"🎯",
        },
        {
          nome:"Alerta: filial com mix concentrado",
          tag:"F2+",
          o_que:"60%+ do faturamento de uma filial em 3 ou menos famílias de produto → alerta de risco de concentração.",
          gera:"Mix diverso = mais resistência a oscilações de demanda. Risco detectado antes de virar crise.",
          icone_neg:"⚠️", icone_pos:"🎯",
        },
        {
          nome:"Janela de safra agrícola",
          tag:"F2+",
          o_que:"Meses antes do pico (set–jan), filiais em regiões agrícolas recebem alerta proativo para reforço de estoque e abordagem.",
          gera:"Antecipar a janela do cliente agro vale muito mais que reagir depois. Imdepa tem presença estratégica no segmento.",
          icone_neg:"🌱", icone_pos:"🚜",
        },
      ],
    },
  ...
  const tAtual=TEMAS.find(t=>t.id===tema);
  const mvpTotal=TEMAS.flatMap(t=>t.features).filter(f=>f.tag==="MVP F2").length;
  const f2pTotal=TEMAS.flatMap(t=>t.features).filter(f=>f.tag==="F2+").length;

  return(
    <div style={{flex:1,overflowY:"auto",backgroundColor:"#F2F2F0"}}>
      <div style={{padding:"10px 24px 0",backgroundColor:C.white,borderBottom:`0.5px solid ${C.border}`}}>
        <div style={{fontSize:11,color:C.hint,marginBottom:8}}>Futuro / Fase 2 · o que construir depois do MVP e o valor que gera</div>
      </div>

      <div style={{padding:"20px 24px 48px"}}>

        {/* ── Banner ── */}
        <div style={{borderRadius:14,marginBottom:20,background:"linear-gradient(135deg,#111 55%,#1C1A2A)",padding:"24px 28px",display:"flex",gap:24,alignItems:"center"}}>
          <div style={{flex:1}}>
            <div style={{fontSize:10,fontWeight:700,color:"rgba(255,255,255,0.4)",letterSpacing:"0.12em",textTransform:"uppercase",marginBottom:10}}>Após o MVP — Fase 2</div>
            <div style={{fontSize:23,fontWeight:800,color:"#fff",letterSpacing:"-0.03em",lineHeight:1.25,marginBottom:10}}>
              Do painel para a<br/>ação comercial
            </div>
            <div style={{fontSize:12.5,color:"rgba(255,255,255,0.55)",lineHeight:1.75,maxWidth:480}}>
              O MVP entrega visibilidade. A Fase 2 transforma dados em comportamento: vendedores agem antes de perder clientes, gerentes identificam riscos antes do fim do mês, diretoria decide com padrões — não com feeling.
            </div>
          </div>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,flexShrink:0}}>
            {[
              {n:"3",          l:"temas",           c:"#C8102E"},
              {n:mvpTotal,     l:"features MVP F2", c:"#C8102E"},
              {n:f2pTotal,     l:"features F2+",    c:"#777"},
              {n:"1",          l:"novo perfil",      c:"#C8102E"},
            ].map(s=>(
              <div key={s.l} style={{background:"rgba(255,255,255,0.06)",borderRadius:10,padding:"12px 14px",textAlign:"center"}}>
                <div style={{fontSize:28,fontWeight:800,color:s.c,lineHeight:1}}>{s.n}</div>
                <div style={{fontSize:9,color:"rgba(255,255,255,0.35)",marginTop:4,textTransform:"uppercase",letterSpacing:"0.06em",lineHeight:1.4}}>{s.l}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          {TEMAS.map(t=>{
            ...
            return(
              <button key={t.id} onClick={()=>setTema(t.id)} style={{
                ...
                backgroundColor:ativo?t.corL:C.white,
                boxShadow:ativo?`0 4px 18px ${t.cor}20`:"0 1px 3px rgba(0,0,0,0.04)",
                transition:"all 0.16s",
              }}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10}}>
                  <div style={{width:38,height:38,borderRadius:10,background:ativo?t.cor:`${t.cor}18`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,transition:"all 0.16s"}}>
                    {t.icone}
                  </div>
                </div>
                <div style={{fontSize:14,fontWeight:800,color:ativo?t.cor:C.text,marginBottom:4,letterSpacing:"-0.01em"}}>{t.titulo}</div>
                <div style={{fontSize:11,color:ativo?`${t.cor}CC`:C.hint,lineHeight:1.5}}>{t.impacto_resumo}</div>
                {t.novo_perfil&&(
                  <div style={{marginTop:8,fontSize:9.5,padding:"2px 8px",borderRadius:10,background:ativo?"#C8102E":"#F0F0F0",color:ativo?"#fff":"#888",fontWeight:700,display:"inline-block"}}>+ novo perfil</div>
                )}
              </button>
            );
          })}
        ...
        {tAtual&&(
          <div style={{display:"flex",flexDirection:"column",gap:10}}>
            ...
            {/* Contexto / problema */}
              <div style={{backgroundColor:C.white,borderRadius:12,padding:"16px 20px",border:`0.5px solid ${C.border}`,borderLeft:`4px solid ${tAtual.cor}`}}>
                <div style={{fontSize:10,fontWeight:700,color:tAtual.cor,textTransform:"uppercase",letterSpacing:"0.07em",marginBottom:6}}>O problema hoje</div>
                <div style={{fontSize:12.5,color:C.text,lineHeight:1.7}}>{tAtual.problema}</div>
              </div>

              {/* Cards de feature */}
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
                {tAtual.features.map((f,i)=>{
                const isMVP=f.tag==="MVP F2";
                return(
                  <div key={i} style={{backgroundColor:C.white,borderRadius:12,border:`0.5px solid ${C.border}`,overflow:"hidden",boxShadow:"0 1px 4px rgba(0,0,0,0.04)"}}>
                    {/* Cabeçalho */}
                    <div style={{padding:"14px 18px 10px",display:"flex",alignItems:"flex-start",gap:12,borderBottom:`0.5px solid ${C.border}`}}>
                      <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:4,flexShrink:0,paddingTop:2}}>
                        <div style={{width:32,height:32,borderRadius:8,background:isMVP?tAtual.cor:"#E0E0E0",display:"flex",alignItems:"center",justifyContent:"center",fontSize:15}}>
                          {f.icone_pos}
                        </div>
                        <span style={{fontSize:8.5,padding:"1px 6px",borderRadius:8,backgroundColor:isMVP?`${tAtual.cor}15`:"#F0F0F0",color:isMVP?tAtual.cor:"#888",fontWeight:800,whiteSpace:"nowrap"}}>{f.tag}</span>
                      </div>
                      <div style={{flex:1}}>
                        <div style={{fontSize:13,fontWeight:700,color:C.text,marginBottom:5}}>{f.nome}</div>
                        <div style={{fontSize:12,color:C.muted,lineHeight:1.65}}>{f.o_que}</div>
                      </div>
                    </div>
                    {/* Valor gerado */}
                    <div style={{padding:"10px 18px",backgroundColor:isMVP?`${tAtual.cor}06`:"#FAFAFA",display:"flex",alignItems:"flex-start",gap:10}}>
                      <div style={{width:22,height:22,borderRadius:6,background:isMVP?`${tAtual.cor}18`:"#EBEBEB",display:"flex",alignItems:"center",justifyContent:"center",fontSize:12,flexShrink:0}}>
                        💡
                      </div>
                      <div>
                        <div style={{fontSize:9.5,fontWeight:700,color:isMVP?tAtual.cor:"#888",textTransform:"uppercase",letterSpacing:"0.06em",marginBottom:3}}>
                          Gera para o negócio
                        </div>
                        <div style={{fontSize:12,color:C.text,lineHeight:1.55,fontWeight:500}}>{f.gera}</div>
                      </div>
                    </div>
                  </div>
                );
